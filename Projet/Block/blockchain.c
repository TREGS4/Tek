...
BLOCK createGenesis(int diff)
{
	...
	TRANSACTION txs = CreateTxs(1000000, "", "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAIj5IHfXRSsLBobVozWyc3bq3A8lnXSdNY/KHPfSxfwTkr7tUk6IOG5O4Rn8abeAiNvBV6NQWH3h6d9DgI3sDd8CAwEAAQ==");
